...
j=1
    if j~=flod_num
     ...
     cv_p=[st:sed];
     Yeast_f1_test_feature = dataall(cv_p,2:65);
     Yeast_f1_test_label=dataall(cv_p,1);
     Tr=dataall;
     Tr(cv_p,:)='';
     A=[Tr];
     Yeast_f1_train_feature= A(:,2:65);
...
j=2
    if j~=flod_num
     ...
     cv_p=[st:sed];
     Yeast_f2_test_feature = dataall(cv_p,2:65);
     Yeast_f2_test_label=dataall(cv_p,1);
     Tr=dataall;
     Tr(cv_p,:)='';
     A=[Tr];
     Yeast_f2_train_feature= A(:,2:65);
...
j=3
    if j~=flod_num
     ...
     cv_p=[st:sed];
     Yeast_f3_test_feature = dataall(cv_p,2:65);
     Yeast_f3_test_label=dataall(cv_p,1);
     Tr=dataall;
     Tr(cv_p,:)='';
     A=[Tr];
     Yeast_f3_train_feature= A(:,2:65);
...
j=4
    if j~=flod_num
     ...
     cv_p=[st:sed];
     Yeast_f4_test_feature = dataall(cv_p,2:65);
     Yeast_f4_test_label=dataall(cv_p,1);
     Tr=dataall;
     Tr(cv_p,:)='';
     A=[Tr];
     Yeast_f4_train_feature= A(:,2:65);
...
j=5
    if j~=flod_num
     ...
     cv_p=[st:sed];
     Yeast_f5_test_feature = dataall(cv_p,2:65);
     Yeast_f5_test_label=dataall(cv_p,1);
     Tr=dataall;
     Tr(cv_p,:)='';
     A=[Tr];
     Yeast_f5_train_feature= A(:,2:65);
